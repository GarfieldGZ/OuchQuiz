    ...
    <form className='searchbar' onSubmit={handleSearch}>
      <Combobox>
        <div className='relative w-full'>
          ...
          />
          <Combobox.Input
            className='search-input md:hidden flex w-48 md:w-72 border-2 border-black rounded-full px-4 py-2 text-base font-mono font-bold'
          ...
          />
          <CustomButton
            containerStyles='md:hidden absolute inset-y-0 right-0 flex items-center rounded-full px-4 text-base font-mono font-bold transition-all duration-300 delay-100 hover:text-white hover:bg-black'
            title='join'
            handleClick={handleSearch}
          />
        </div>
